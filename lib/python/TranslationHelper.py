...
translate = _("Back USB 2.0")
translate = _("Back, upper USB")
translate = _("Back, lower USB")
translate = _("Back, lower USB 2.0")
translate = _("Back, upper USB 2.0")
translate = _("Back, lower USB 3.0")
...
translate = _("Back, right USB 3.0")
translate = _("Back, left USB 3.0")
