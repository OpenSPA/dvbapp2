...
class International:
	...
	LANGUAGE_DATA = {
		...
		"ar": ("Arabic", _("Arabic"), "العربية", "ISO-8859-15", "", ("AE", "BH", "DJ", "DZ", "EG", "EH", "ER", "IL", "IQ", "JO", "KM", "KW", "LB", "LY", "MA", "MR", "OM", "PS", "QA", "SA", "SD", "SO", "SS", "SY", "TD", "TN", "YE")),
...
#		"ES-GA": ("ESP", "724", "Galicia (Spain)", _("Galicia (Spain)"), "Galicia (España)"),
	...
	def activateLocale(self, locale, runCallbacks=True):
		...
		### OPENSPA [morser] Generate ISO3166 table after activating the language
