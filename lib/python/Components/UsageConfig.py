...
def InitUsageConfig():
	...
	config.usage.quality_icon_mode = ConfigSelection(default = "0", choices = [("0", _("None")), ("1", _("Left from servicename")), ("2", _("Right from servicename"))])
...
#		value bar
	...
	config.usage.on_short_yellow_key = ConfigSelection(default='0', choices = [('0',_("Audio Selection")),('1',_("Timeshift")),('2',_("Toggle Pillarbox <> Pan&Scan")),('3',_("Teletext"))])
	config.usage.on_long_yellow_key = ConfigSelection(default='1', choices = [('0',_("Audio Selection")),('1',_("Timeshift")),('2',_("Toggle Pillarbox <> Pan&Scan")),('3',_("Teletext"))])
	...
	config.misc.epgcachepath = ConfigText(default = '/etc/enigma2/')
	...
	if SystemInfo["WakeOnLAN"]:
		def wakeOnLANChanged(configElement):
			if getMachineBuild() in ('multibox','plus','hd61','hd60','i55plus','h9twin','h9combo','h10','h9','et7000', 'et7100', 'et7500', 'gbx1', 'gbx2', 'gbx3', 'gbx3h', 'et10000', 'gbquadplus', 'gbquad', 'gb800ueplus', 'gb800seplus', 'gbultraue', 'gbultraueh', 'gbultrase', 'gbipbox', 'quadbox2400', 'mutant2400', 'et7x00', 'et8500', 'et8500s','hzero','h8'):
	...
	config.cccaminfo.ip = ConfigText(default="192.168.1.2", fixed_size = False)
