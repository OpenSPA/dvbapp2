...
def getCPUSpeedString():
	if getMachineBuild() in ('wetekplay'):
		...
		return "1,3 GHz"
	elif getMachineBuild() in ('u51', 'u52', 'u53', 'u54', 'u5', 'u5pvr', 'h9', 'h9combo', 'cc1', 'sf8008', 'hd60', 'i55plus', 'ustym4kpro', 'v8plus'):
		return "1,6 GHz"
		...
		for x in lines:
			...
			if len(splitted) > 1:
				...
				if splitted[0].startswith("processor"):
					if getMachineBuild() in ('u51', 'u52', 'u53', 'u54', 'vuultimo4k', 'u5', 'u5pvr', 'h9', 'h9combo', 'alien5', 'cc1', 'sf8008', 'hd60', 'i55plus', 'ustym4kpro', 'v8plus', 'vuduo4k'):
						cores = 4
