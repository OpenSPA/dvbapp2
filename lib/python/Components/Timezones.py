...
# area" is selected to be "Europe".  This allows OpenATV to have the
# European default of "Berlin" while OpenSPA can select "Madrid",
...
# the image.  For example, Beyonwiz would use "Australia", OpenATV, OpenPLi
# and OpenSPA would use "Europe".  If the "Europe" option is selected then
...
# "Berlin" while OpenSPA may prefer "Madrid".
#
...
DEFAULT_AREA = "Europe"  # OpenATV, OpenPLi, OpenSPA
