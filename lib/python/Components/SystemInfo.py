...
BoxInfo.setItem("LCDClockSetup",fileExists("/usr/share/enigma2/display") and DISPLAYTYPE not in ('textlcd', '7segment', 'bwlcd128') and not fileExists("/usr/lib/enigma2/python/Plugins/Extensions/LCD4linux/plugin.py"))
