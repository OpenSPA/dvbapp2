...
SystemInfo["HDMICEC"] = (fileExists("/dev/hdmi_cec") or fileExists("/dev/misc/hdmi_cec0")) and (fileExists("/usr/lib/enigma2/python/Plugins/SystemPlugins/HdmiCEC/plugin.py") or fileExists("/usr/lib/enigma2/python/Plugins/SystemPlugins/HdmiCEC/plugin.pyc"))
SystemInfo["SABSetup"] = fileExists("/usr/lib/enigma2/python/Plugins/SystemPlugins/SABnzbd/plugin.py") or fileExists("/usr/lib/enigma2/python/Plugins/SystemPlugins/SABnzbd/plugin.pyc")
...
SystemInfo["Blindscan"] = fileExists("/usr/lib/enigma2/python/Plugins/SystemPlugins/Blindscan/plugin.py") or fileExists("/usr/lib/enigma2/python/Plugins/SystemPlugins/Blindscan/plugin.pyc")
SystemInfo["Satfinder"] = fileExists("/usr/lib/enigma2/python/Plugins/SystemPlugins/Satfinder/plugin.py") or fileExists("/usr/lib/enigma2/python/Plugins/SystemPlugins/Satfinder/plugin.pyc")
...
SystemInfo["LCDSKINSetup"] = pathExists("/usr/share/enigma2/display") and not fileExists("/usr/lib/enigma2/python/Plugins/Extensions/LCD4linux/plugin.py") or SystemInfo["VuplusVFD"]
SystemInfo["LCDClockSetup"] = pathExists("/usr/share/enigma2/display") and getDisplayType() not in ('textlcd','7segment') and not fileExists("/usr/lib/enigma2/python/Plugins/Extensions/LCD4linux/plugin.py")
...
SystemInfo["HasMultiboxSupport"] = HardwareInfo().get_device_name() not in ("et4000", "et5000", "sh1", "hd500c", "dm900", "dm920")
...
SystemInfo["HasFullHDSkinSupport"] = getBoxType() not in ("et4000", "et5000", "sh1", "hd500c", "hd1100", "xp1000", "lc", "iziboxecohd", "jdhdduo")
SystemInfo["CanProc"] = SystemInfo["HasMMC"] and getBrandOEM() != "vuplus"
