...
SystemInfo["LCDClockSetup"] = path.exists("/usr/share/enigma2/display") and getDisplayType() not in ('7segment') and not fileExists("/usr/lib/enigma2/python/Plugins/Extensions/LCD4linux/plugin.pyo")
