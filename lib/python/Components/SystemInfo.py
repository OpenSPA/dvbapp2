...
BoxInfo.setItem("CanKexecVu", MODEL in ("vusolo4k", "vuduo4k", "vuduo4kse", "vuultimo4k", "vuuno4k", "vuuno4kse", "vuzero4k") and not BoxInfo.getItem("HasKexecMultiboot"))
BoxInfo.setItem("VuUUIDSlot",None)
