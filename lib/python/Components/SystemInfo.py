...
BoxInfo.setItem("LCDClockSetup",fileExists("/usr/share/enigma2/display") and DISPLAYTYPE in ('colorlcd220', 'colorlcd400', 'colorlcd400s', 'colorlcd480', 'colorlcd800') and not fileExists("/usr/lib/enigma2/python/Plugins/Extensions/LCD4linux/plugin.py"))
