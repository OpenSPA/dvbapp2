...
def updateSysSoftCam():
	...
	BoxInfo.setMutableItem("CurrentSoftcam", getSysSoftcam())
...
BoxInfo.setItem("HDMICEC", fileExists("/dev/hdmi_cec") or fileExists("/dev/cec") or fileExists("/dev/misc/hdmi_cec0"))
