...
class MultiBootWizard(Screen):
	...
	skin = """
	<screen name="MultiBoot Image Manager" position="center,center" size="750,620" flags="wfNoBorder" backgroundColor="transparent">
		...
		<eLabel position="20,205" size="6,30" backgroundColor="#00e61700" /> <!-- Should be a pixmap red  -->
		<eLabel position="190,205" size="6,30" backgroundColor="#0061e500" /> <!-- Should be a pixmap green  -->
		<eLabel position="360,205" size="6,30" backgroundColor="#ffff00" /> <!-- Should be a pixmap  yellow-->
	</screen>
	"""
