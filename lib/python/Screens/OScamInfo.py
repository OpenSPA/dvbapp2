...
class OSCamInfo(Screen, OSCamGlobals):
	skin = """
		<screen name="OSCamInfo" position="center,center" size="1950,1080" backgroundColor="#10101010" title="OSCam Information" flags="wfNoBorder" resolution="1920,1080">
			...
			<widget name="logtext" position="15,812" size="1890,150" font="Regular;24" horizontalAlignment="left" verticalAlignment="top" padding="10,0,10,0" foregroundColor="black" backgroundColor="#10ECEAF6" noWrap="0" scrollbarMode="showNever" />
			...
			<eLabel name="blue" position="980,1010" size="10,65" backgroundColor="blue" zPosition="1" />
			...
			<widget source="key_yellow" render="Label" position="640,1020" size="380,42" font="Regular;30" horizontalAlignment="left" verticalAlignment="center" foregroundColor="grey" />
			<widget source="key_blue" render="Label" position="1000,1020" size="380,42" font="Regular;30" horizontalAlignment="left" verticalAlignment="center" foregroundColor="grey" />
			<widget source="key_OK" render="Label" position="1400,1020" size="60,42" font="Regular;30" horizontalAlignment="center" verticalAlignment="center" foregroundColor="black" backgroundColor="grey">
