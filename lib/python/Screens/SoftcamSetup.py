...
from Components.config import ConfigSelection, getConfigListEntry, ConfigAction, ConfigSubsection, config, ConfigYesNo
...
class SoftcamSetup(Screen, ConfigListScreen):
	...
	def ppanelShortcut(self):
		...
		elif "ncam" in self.softcams.value.lower() and os.path.isfile('/usr/lib/enigma2/python/Screens/NcamInfo.pyo'):
