...
class MultiBootSelector(Screen):
	...
	skin = """
	<screen name="Multiboot Image Selector" position="center,center" size="750,620" flags="wfNoBorder" backgroundColor="transparent">
		...
		<widget name="config" position="10,280" size="722,380" itemHeight="32" halign="center" font="Regular; 22" backgroundColor="#00000000" foregroundColor="#00e5b243" />
		<widget source="description" render="Label" position="2,70" size="730,60" halign="center" font="Regular; 22" backgroundColor="#00000000" foregroundColor="#00ffffff" />
		<widget source="options" render="Label" position="2,135" size="730,60" halign="center" font="Regular; 22" backgroundColor="#00000000" foregroundColor="#00ffffff" />
		...
		<widget source="key_green" render="Label" position="200,205" size="194,30" noWrap="1" zPosition="1" valign="center" font="Regular; 20" halign="left" backgroundColor="#00000000" foregroundColor="#00ffffff" />
		<eLabel position="20,205" size="6,30" backgroundColor="#00e61700" /> <!-- Should be a pixmap -->
		<eLabel position="190,205" size="6,30" backgroundColor="#0061e500" /> <!-- Should be a pixmap -->
	</screen>
	"""
