...
#
	...
	def gotRecordEvent(self, record, event):
		...
		if event == iRecordableService.evRecordWriteError:
			...
			notify = config.usage.show_message_when_recording_starts.value and not Screens.Standby.inStandby and Screens.InfoBar.InfoBar.instance and Screens.InfoBar.InfoBar.instance.execing
